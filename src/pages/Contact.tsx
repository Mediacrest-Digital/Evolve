  ...
  const faqs = [
    {
      ...
      answer:
        "We can typically begin services within 24-48 hours after initial consultation and assessment.",
    },
    {
      question: "Do you accept insurance?",
      answer:
        "Yes, we work with most major insurance providers and can help verify your coverage benefits.",
    },
    {
      question: "Are your caregivers licensed and insured?",
      answer:
        "All our caregivers are licensed, bonded, and insured. We conduct thorough background checks and ongoing training.",
    },
    {
      question: "Can I choose my caregiver?",
      answer:
        "Absolutely! We work with you to match the right caregiver based on personality, experience, and specific care needs.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Ready to start your home healthcare journey? Contact us today for
              a free consultation and personalized care plan tailored to your
              unique needs.
            </p>
          </motion.div>
        </div>
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                ...
                with the care you need. Choose the method that works best for
                you.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="h-full text-center border border-primary/20 hover:shadow-lg transition">
                  <CardContent className="p-6 space-y-4">
                    ...
                    {info.action !== "#" && (
                      <Button
                        ...
                        style={{ background: "#0d383e", color: "#fff" }}
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="space-y-6">
                  ...
                  <Button
                    ...
                    style={{ background: "#0d383e", color: "#fff" }}
                  >
                    <Send className="w-5 h-5 mr-2" style={{ color: "#fff" }} />
                    Send Message
                  </Button>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">0112 829 166</p>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Home visits available citywide
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-6 border-t">
                    ...
                    <div className="flex space-x-3">
                      <a
                        href="https://www.facebook.com/evolvehomecareke/"
                      ...
                      <a
                        href="https://www.instagram.com/evolvehomecareke/"
                        className="w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                        style={{ background: "#0d383e" }}
                      >
                        <Instagram
                      ...
                      <a
                        href=" https://www.linkedin.com/company/evolve-homecare-ke/"
                        className="w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                        style={{ background: "#0d383e" }}
                      >
                        <Linkedin
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="border border-primary/20 hover:shadow-lg transition">
